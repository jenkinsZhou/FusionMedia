...
import com.tourcoo.core.entity.FrameTabEntity;
import com.tourcoo.core.log.TourCooLogUtil;
import com.tourcoo.core.manager.TabLayoutManager;
...
public class MainTabDelegate {
    ...
    public MainTabDelegate(View rootView, FragmentActivity activity, IFastMainView iFastMainView) {
    ...
    public MainTabDelegate(View rootView, Fragment activity, IFastMainView iFastMainView) {
        if (iFastMainView == null || rootView == null || activity == null) {
            return;
        }
    ...
    private void initTabLayout() {
        ...
        TourCooLogUtil.i("initTabLayout", "position:" + mSelectedPosition + ";getCurrentTab:" + mTabLayout.getCurrentTab());
    ...
    public void onDestroy() {
        ...
        TourCooLogUtil.i("FastMainTabDelegate", "onDestroy");
    }
}
