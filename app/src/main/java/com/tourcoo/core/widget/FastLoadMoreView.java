package com.tourcoo.core.widget;
...
public class FastLoadMoreView extends LoadMoreView {
    ...
    public int getLayoutId() {
        return R.layout.frame_layout_load_more_view;
    }
    ...
    public static final class Builder {
        ...
        public Builder(@Nullable Context context) {
            ...
            setLoadingSize(-1);
            setLoadingText(R.string.frame_load_more_loading);
            setLoadFailText(R.string.frame_load_more_load_failed);
            setLoadEndText(R.string.frame_load_more_load_end);
        }
