...
public class FrameFileUtil {
    ...
    public static String getCacheDir() {
        ...
        String fileDir = context.getString(R.string.frame_external_cache_dir);
        if (cacheDir == null) {
            //data/data/<package-name>/cache/xxx/
            cacheDir = context.getCacheDir();
            fileDir = context.getString(R.string.frame_cache_dir);
        }
    ...
    public static String getExternalStorageDirectory() {
        ...
        String fileDir = context.getString(R.string.frame_external_storage_directory);
        //该路径需和fast_file_path配置一致
    ...
    public static String getFilesDir() {
        ...
        String fileDir = context.getString(R.string.frame_files_dir);
        //该路径需和fast_file_path配置一致
        file = new File(file, fileDir);
        return file.getAbsolutePath();
    }
    ...
    public static String getExternalFilesDir() {
        ...
        String fileDir = context.getString(R.string.frame_external_files_dir);
        //该路径需和fast_file_path配置一致
        file = new File(file, fileDir);
        return file.getAbsolutePath();
    }
